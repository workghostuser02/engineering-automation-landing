...
**Опубликованная версия:** https://workghostuser02.github.io/engineering-automation-landing/
...
Нужно заменить учебное название и тексты подтверждёнными данными заказчика, добавить реальные контакты, услуги, цены, кейсы или отзывы, документы и серверную отправку формы. При переносе на домен заказчика также нужно заменить абсолютные `og:url`, `og:image` и canonical URL.
